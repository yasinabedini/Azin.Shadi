        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceTypeTitle = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Forwards_ForwardId",
            ...
            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "ParentId", "PermissionTitle" },
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleId", "IsDelete", "Title" },
                values: new object[,]
                {
                    { 1, false, "مدیر سایت" },
                    { 2, false, "فروشنده" },
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "TransactionTypeId", "InvoiceTypeTitle" },
                values: new object[,]
                {
                    { 1, "OnlinePayment" },
                    { 2, "WalletPayment" },
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "ActivationCode", "Email", "EmailConfrimation", "IsActive", "IsDelete", "Name", "Password", "ProfileName", "RegisterDate", "Username" },
                values: new object[] { 1, "2b7528060679435088ba01f27e4eb63f", "yasinabedini1384@gmail.com", true, true, false, "یاسین عابدینی", "3F-DF-50-75-BD-FF-CD-76-85-D8-46-89-11-FD-CD-C1", "ce7ca676827f42e485b9167a86f19a6f.jpg", new DateTime(2023, 8, 29, 18, 3, 47, 439, DateTimeKind.Local).AddTicks(7833), "2f649a9139" });
