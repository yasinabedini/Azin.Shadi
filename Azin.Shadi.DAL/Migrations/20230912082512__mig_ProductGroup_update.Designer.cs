...
namespace Azin.Shadi.DAL.Migrations
{
    ...
    [Migration("20230912082512__mig_ProductGroup_update")]
    partial class _mig_ProductGroup_update
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Azin.Shadi.DAL.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterDate = new DateTime(2023, 9, 12, 11, 55, 12, 432, DateTimeKind.Local).AddTicks(9159),
                            Username = "2f649a9139"
                        });
                });
