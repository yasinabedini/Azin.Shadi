...
namespace Azin.Shadi.DAL.Migrations
{
    ...
    [Migration("20230829144342__mig_orderStatus_update")]
    partial class _mig_orderStatus_update
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Azin.Shadi.DAL.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterDate = new DateTime(2023, 8, 29, 18, 13, 42, 343, DateTimeKind.Local).AddTicks(4764),
                            Username = "2f649a9139"
                        });
                });
